...
OBS_MODULE_AUTHOR("LAIVE AI - Thayron Sabino")
...
bool obs_module_load()
{
    ...
    blog(LOG_INFO, TAG "version: %s by LAIVE AI - Thayron Sabino https://github.com/thayronsabino/laive-obs-stream", PLUGIN_VERSION);
